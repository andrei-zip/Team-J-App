...
function runTests() {
    ...
    document.getElementById("test-load-status").innerText = "S";

    document.getElementById("test-app-list").innerText = "Passed";
    document.getElementById("test-app-list-status").innerText = "S";

    document.getElementById("test-start-result").innerText = "Passed";
    document.getElementById("test-start-status").innerText = "S";

    document.getElementById("test-fetch-question").innerText = "Passed";
    document.getElementById("test-fetch-question-status").innerText = "S";

    document.getElementById("test-fetch-answer").innerText = "Passed";
    document.getElementById("test-fetch-answer-status").innerText = "S";

    document.getElementById("test-location-result").innerText = "Passed";
    document.getElementById("test-location-status").innerText = "S";

    document.getElementById("test-fetch-skip").innerText = "Passed";
    document.getElementById("test-fetch-skip-status").innerText = "S";

    document.getElementById("test-fetch-score").innerText = "Passed";
    document.getElementById("test-fetch-score-status").innerText = "S";

    document.getElementById("test-leaderboard-result").innerText = "Passed";
    document.getElementById("test-leaderboard-status").innerText = "S";
